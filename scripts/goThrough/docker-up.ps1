...
.EXAMPLE
    .\scripts\goThrough\docker-up.ps1
    .\scripts\goThrough\docker-up.ps1 -Debug
    .\scripts\goThrough\docker-up.ps1 -Debug -Watch
    .\scripts\goThrough\docker-up.ps1 -Services backend,frontend -Build
#>
[CmdletBinding()]
param(
    [switch]$Watch,
...
try {
    ...
    if ($Watch) {
        ...
        Write-Info 'Containers are still running. Stop with: .\scripts\goThrough\docker-down.ps1'
    }
    exit 0
} catch {
