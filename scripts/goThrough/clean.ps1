...
.EXAMPLE
    .\scripts\goThrough\clean.ps1
    .\scripts\goThrough\clean.ps1 -Verbose
#>
[CmdletBinding()]
param()
...
try {
    ...
    Write-Info 'For a full wipe: .\scripts\reset.ps1 -Volumes   | for deep disk cleanup: .\scripts\goThrough\prune.ps1'
    exit 0
} catch {
